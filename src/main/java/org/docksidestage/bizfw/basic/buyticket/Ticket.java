...
public class Ticket {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    // TODO itoryu 引数を変えたことで、step6のクラスで影響が出ているので、正しく動作するように(step6を)修正しましょう by jflute (2025/10/17)
    ...
    // TODO itoryu validよりはvalidateの方が直感的かなと (動詞始まり) by jflute (2025/10/17)
    private void validEnterCondition() {
        ...
        // TODO itoryu 他にもnightなチケット種別が増えた時、ここに条件を増やさないといけない by jflute (2025/10/17)
    ...
    private boolean isNightTime(OffsetTime time) {
        // TODO itoryu 17時の表現が2回登場して、かつ長いのでちょっとstatementの区切りがわかりづらいので... by jflute (2025/10/17)
